...
public class CustomLRUCacheDriver {
    public static void main(String[] args){
        ...
        customLRU.put(2, "Bob");
        System.out.print("Fetching key 1: " + customLRU.get(1).toString() + "::");
        customLRU.showLRUcache();
        customLRU.put(3, "Charlie");
        customLRU.put(4, "Dale");
        System.out.print("Fetching key 1: " + customLRU.get(1).toString() + "::");
        customLRU.showLRUcache();
        System.out.print("Fetching key 4: " + customLRU.get(4).toString() + "::");
        customLRU.showLRUcache();
        System.out.print("Fetching key 3: " + customLRU.get(3).toString() + "::");
        customLRU.showLRUcache();
        customLRU.put(2,"Bob");
    }
}
